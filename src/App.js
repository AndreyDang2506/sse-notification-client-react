...
import { BellFilled, MessageFilled, HomeFilled, UserOutlined } from '@ant-design/icons';
...
class App extends Component {
  ...
  initListener = () => {
    ...
    eventSource.onmessage = e => this.handleServerEvent(e);
  };
            ...
            <div className="menuBar">
              ...
              <div className="menuCon">
                <div className="rightMenu">
                  <a href="#">
                    <HomeFilled className="icon-dimmed" type="home" theme="filled" />
                  </a>
                  <a href="#">
                    <MessageFilled
